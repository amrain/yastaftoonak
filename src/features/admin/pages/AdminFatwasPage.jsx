...
// 1. استيراد المحرر الجديد البديل لـ React 19
import ReactQuill from 'react-quill-new';

// 2. استيراد ملف التنسيق (CSS) الخاص بالحزمة الجديدة
...
function AdminFatwasPage({ currentUser, deleteFatwaById, fatwas, saveFatwaReply, categories = [] }) {
  ...
  const quillFormats = [
    'header', 'bold', 'italic', 'underline', 'color', 'background', 'direction', 'align'
  ];
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                 ...
                 <div className="admin-rich-editor bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <ReactQuill 
                      ...
                      onChange={(htmlValue) => setReplyData({ ...replyData, answer: htmlValue })}

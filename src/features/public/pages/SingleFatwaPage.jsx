...
function SingleFatwaPage({ fatwas, themeColors }) {  const navigate = useNavigate();
  ...
  // مخرجات تنظيف النص: استبدال المسافات غير القابلة للكسر بمسافات عادية
  const cleanAnswer = fatwa.answer ? fatwa.answer.replace(/&nbsp;/g, ' ') : '';
      ...
      <div className="bg-white dark:bg-gray-800 w-full rounded-3xl shadow-xl overflow-hidden flex flex-col border-t-4 border-amber-500">
        ...
        <div className="p-6 md:p-10">
          <div className="mb-8 relative">
            ...
            {/* تم تغيير text-justify إلى text-right هنا */}
            <h3 className={`!font-salaf text-2xl md:text-2xl font-normal ${themeColors.textMain} leading-[2] text-right pr-4 md:pr-6`} dir="rtl" style={{ wordBreak: 'break-word' }}>
          ...
          <div className="bg-emerald-50/50 dark:bg-emerald-900/10 p-6 md:p-8 rounded-tl-3xl rounded-br-3xl border border-emerald-100 dark:border-emerald-800/50">
            {/* تم تغيير text-justify إلى text-right هنا لحل مشكلة التداخل */}
            <p className={`!font-salaf ${themeColors.textMain} text-xl md:text-2xl leading-[2] text-right pr-4 md:pr-6`}>
              ...
              {/* نقوم بتمرير النص النظيف cleanAnswer بدلاً من fatwa.answer المعطوب */}
              <FatwaLinkParser text={cleanAnswer} fatwas={fatwas} />
            </p>
          </div>
        </div>
...
//   <h3 className={`!font-salaf text-2xl md:text-2xl font-normal ${themeColors.textMain} leading-[2] text-justify pr-4 md:pr-6`} dir="rtl" style={{ wordBreak: 'break-word' }}>
//     <span className="text-amber-500 ml-3 font-sans text-base border border-amber-200 bg-amber-50 dark:bg-amber-900/30 w-8 h-8 inline-flex items-center justify-center rounded-full">س</span>
//     {fatwa.question}
//   </h3>
// </div>
